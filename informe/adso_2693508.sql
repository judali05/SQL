...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 10-05-2024 a las 02:01:13
...
INSERT INTO `evaluaciones` (`id_evaluacion`, `tipo_evaluacion`) VALUES
(1, 'por evaluar'),
(2, 'aprobado'),
(3, 'no aprobado');
...
INSERT INTO `instructores` (`documento`, `id_tipo`, `instructor`) VALUES
(1, 3, 'por ingresar\r\n');
...
--
ALTER TABLE `juicios`
  MODIFY `id_juicio` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3330;
...
--
ALTER TABLE `instructores`
  ADD CONSTRAINT `re_9` FOREIGN KEY (`id_tipo`) REFERENCES `tipo_documentos` (`id_tipo`) ON DELETE CASCADE ON UPDATE CASCADE;
...
ALTER TABLE `juicios`
  ...
  ADD CONSTRAINT `re_8` FOREIGN KEY (`id_instructor`) REFERENCES `instructores` (`documento`) ON DELETE CASCADE ON UPDATE CASCADE;
